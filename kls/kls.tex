...
\section{A More Detailed Look}
	...
	% \subsection{The Connection to Ball-Step and the Log-Sobolev Constant}

	% 	\subsection{The Log-Sobolev Constant}
...
\section{Recent Bounds on the Isoperimetric Constant}
	...
	\subsection{An Almost Constant Bound}
		...
		\begin{proof}
			...
			Taking the expectation on either side and using the bound,
